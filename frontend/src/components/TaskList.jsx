  ...
  return (
    <div className="app__tasklist__wrapper">
      <ul>
        ...
        { props.canCreate ? <li><button onClick={ () => props.addNewTask() }>Ajouter une tâche...</button><input type="text" key={ "add-new-task-button" } name="new-task-name" id ="new-task-name" placeholder="Ajouter une tâche" onChange={ (e) => props.setNewTaskName(e.target.value) } /></li> : "" }
        </ul>
    </div>
  );
}
